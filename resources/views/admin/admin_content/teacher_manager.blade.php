...
<div class="col-md-12 post">
    <button type="button" class="btn btn-outline-success"  data-toggle="modal" data-target="#create-teacher">Thêm giảng viên</button>
    <br><br>
    ...
    <table class="table">
        ...
        <tbody>
            @forelse($users->where("level","gv") as $user )
